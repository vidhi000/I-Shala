   ...
   return (
      ...
      <nav className="flex mx-96 ">
         ...
         <div className="flex flex-grow justify-end items-center space-x-10">
            ...
            <Link href='/login'>
            <button className="border px-5 py-2 border-sky-700 rounded-sm font-semibold text-sky-500 shadow-md hover:shadow-lg hover:text-sky-600 text-lg">Login</button>
            </Link>
            <Link href={'/auth'}>
