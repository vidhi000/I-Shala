...
const submit = () =>{
    ...
    return(
        ...
        <div className="min-h-screen max-w-screen-lg mx-auto mb-32 mt-24 border rounded-lg p-8 shadow-2xl">
            <div className="max-w-screen-lg mx-auto border rounded-md p-8 bg-green-200 flex justify-evenly shadow-lg">
           <img src="https://internshala.com/static/images/common/modal_success.svg" height={100} width={100}
            className="bg-green-200 ml-12 justify-center" />
            <div>
            ...
            <div className="flex mt-20 space-x-4">
                ...
                <ArrowRightIcon className="text-sky-500 hover:text-sky-600 h-5 w-5" />
            </div>
        </div>
        </>
    );
